...
🔗 **[랜딩 페이지에서 직접 조명을 끌어보세요](https://jsonpassion.github.io/MyLittleSunshine/)**
...
```
MyLittleSunshine/     앱 타깃 (Xcode 동기화 폴더)
...
xcodebuild -project MyLittleSunshine.xcodeproj -scheme MyLittleSunshine build
```
